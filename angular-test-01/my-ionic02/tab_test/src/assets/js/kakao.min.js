...
Kakao.init('e5e1a3103811f294d1e6b54471fe7a8f');
Kakao.isInitialized();
...
function loginWithKakao() {
    ...
    Kakao.Auth.login({ success : function(authObj) {
        Kakao.API.request({ url : '/v2/user/me', success : function(res) {
            ...
            var param = document.kakaoParam;
            param.id.value = res.id;
            param.email.value = res.kaccount_email;
            param.nickname.value = res.properties['nickname'];
            param.access_token.value = authObj.access_token;
            param.action = "/";
            param.method = "post";
            // param.submit();
            console.log(param);
...
var naver_id_login = new naver_id_login("yeoXdUtxPpcjkxR4G932", "localhost:8200");
  	var state = naver_id_login.getUniqState();
  	naver_id_login.setButton("white", 2,40);
  	naver_id_login.setDomain("localhost:8200");
